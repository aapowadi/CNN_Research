...
class Model_4:
    ...
    def createModel(self, X, Xd, Xpred, p_keep_conv, p_keep_hidden, img_width, img_height):
        ...
        self.w5t = init_weights([3, 3, 32, 4], "w5t") # 64 x 64 x 32 -> 32 x 32 x 4
        self.wf1 = init_weights([32 * 32 * 4, 625], "wf1")
        ...
        self.w5r = init_weights([3, 3, 32, 4], "w5r")  # 64 x 64 x 32 -> 32 x 32 x 4
        self.wf1_r = init_weights([32 * 32 * 4, 825], "wf1_r")
